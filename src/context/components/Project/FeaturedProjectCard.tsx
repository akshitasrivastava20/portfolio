      ...
      <div className="flex flex-col gap-6">
        ...
        >
          <div className="group relative flex cursor-pointer flex-col gap-1 rounded-lg border border-gray-400/50 bg-[#e8e4e7]/70 p-1 shadow-2xl backdrop-blur-sm dark:border-white/10 dark:bg-[#121212] dark:shadow-[#121212]/50">
            ...
            <div className="flex h-full justify-center overflow-hidden rounded-lg">
              {videoSrc ? (
                <Suspense
                  fallback={
                    <Image
        ...
        <div className="space-y-3 p-2">
          ...
          <p className="mb-2 text-sm text-gray-800 dark:text-gray-50">
            {timeline}
          </p>
          <p className="mb-4 text-sm dark:text-slate-300">{tagline}</p>
