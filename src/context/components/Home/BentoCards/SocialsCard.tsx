import { Discord } from '@/context/components/Icons/socials/Discord'
import { Linkedin } from '@/context/components/Icons/socials/Linkedin'
import { Twitter } from '@/context/components/Icons/socials/Twitter'
import { Leetcode } from '@/context/components/Icons/socials/Leetcode'
import BentoCard from './BentoCard'
import { Instagram } from '@/context/components/Icons/socials/Spotify'
...
const socials = [
  ...
  },
  {
    name: 'LinkedIn',
    icon: Linkedin,
    link: 'https://www.linkedin.com/in/akshitasrivastava20/',
    translateX: '12px',
    rotate: '-10deg',
    zIndex: 1,
  },
...

  {
    name: 'Leetcode',
    icon: Leetcode,
    link: 'https://leetcode.com/akshitasrivastava20',
    translateX: '-12px',
    rotate: '10deg',
    zIndex: 1,
  },
  {
    name: 'Instagram',
    icon: Instagram,
    link: 'https://instagram.com/akshita8368',
    translateX: '-24px',
    rotate: '20deg',
    zIndex: 0,
  },
...
const SocialsCard = () => {
  return (
    <BentoCard className="group-social col-span-5 row-span-1 h-56 p-4 xs:col-span-3 xs:row-span-2 lg:p-6">
      ...
      <div className="flex size-full items-center justify-center gap-[5px] font-mono font-semibold">
        {socials.map((social) => (
          <SocialCard
            key={social.name}
            icon={social.icon}
